...
import com.youzan.bigdata.base.Boostable;
 ...
 * <br>
 * Created by maoxiajun on 18/10/26.
 */
@UnThreadSafe
public class Script implements QueryCondition, Boostable<Script> {
    ...
    public Script addParam(String key, Object value) {
        if (null == this.params) {
            this.params = Maps2.of(key, value);
        } else {
