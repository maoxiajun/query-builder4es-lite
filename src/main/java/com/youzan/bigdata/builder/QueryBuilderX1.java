...
import com.youzan.bigdata.base.*;
...
public class QueryBuilderX1 {
     ...
     * @return self
     */
    public QueryBuilderX1 addFilter(QueryCondition cond) {
     ...
     * @return self
     */
    public QueryBuilderX1 addQuery(QueryCondition cond) {
     ...
     * @return self
     */
    public QueryBuilderX1 size(int size) {
        this.size = size;
        return this;
    }
     ...
     * @return self
     */
    public QueryBuilderX1 from(int from) {
        this.from = from;
        return this;
    }
     ...
     * @return self
     */
    public QueryBuilderX1 sort(QueryCondition cond) {
        this.sort = cond;
        return this;
    }
     ...
     * @return self
     */
    public QueryBuilderX1 source(QueryCondition cond) {
        this.source = cond;
        return this;
    }
     ...
     * @return self
     */
    public QueryBuilderX1 highlight(QueryCondition cond) {
        this.highlight = cond;
        return this;
    }
